...
data class ProfileCategory(
     ...
     */
    fun getProfilesByWeight(): List<BotProfile> {
        return profiles.sortedByDescending { it.weight }
    }
    
    /**
     * Gets profiles that are eligible based on player flags
     */
    fun getEligibleProfiles(playerFlags: Set<String>): List<BotProfile> {
     ...
     */
    fun hasEligibleProfile(playerFlags: Set<String>): Boolean {
